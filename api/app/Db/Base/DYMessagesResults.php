...
/**
 * Class DYMessagesResults
 */
abstract class DYMessagesResults extends ORMResultsBase
{
	/**
	 * DYMessagesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYMessage::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYMessage
	 */
