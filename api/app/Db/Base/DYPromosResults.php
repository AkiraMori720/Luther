...
/**
 * Class DYPromosResults
 */
abstract class DYPromosResults extends ORMResultsBase
{
	/**
	 * DYPromosResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYPromo::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYPromo
	 */
