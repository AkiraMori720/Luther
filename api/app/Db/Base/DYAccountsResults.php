...
/**
 * Class DYAccountsResults
 */
abstract class DYAccountsResults extends ORMResultsBase
{
	/**
	 * DYAccountsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYAccount::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYAccount
	 */
