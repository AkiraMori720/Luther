 ...
 * Class DYVatsQuery
 */
abstract class DYVatsQuery extends ORMTableQueryBase
{
	/**
	 * DYVatsQuery constructor.
	 */
	public function __construct()
	{
		parent::__construct(
			...
			DYVat::TABLE_NAME,
			\DELIVERY\App\Db\DYVatsResults::class
		);
	}

	/**
	 * Finds rows in the table `dy_vats` and returns a new instance of the table's result iterator.
	 *
	 * @param null|int $max
	 * @param int      $offset
	 ...
	 *
	 * @return \DELIVERY\App\Db\DYVatsResults
	 */
	public function find($max = null, $offset = 0, array $order_by = [])
	{
		/* @var \DELIVERY\App\Db\DYVatsResults $results */
	...
	/**
	 * Filters rows with condition on column `id` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	 * @return $this|\DELIVERY\App\Db\DYVatsQuery
	 * @throws \Gobl\DBAL\Exceptions\DBALException
	...
	/**
	 * Filters rows with condition on column `company_id` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `type` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `name` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `value` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	 ...
	 * @throws \Gobl\ORM\Exceptions\ORMException
	 */
	public function filterByValue($value, $operator = Rule::OP_EQ)
	{
		return $this->filterBy('value', $value, $operator);
	}

	/**
	 * Filters rows with condition on column `data` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `add_time` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `update_time` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `valid` in the table `dy_vats`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
