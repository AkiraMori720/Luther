...
/**
 * Class DYChatsResults
 */
abstract class DYChatsResults extends ORMResultsBase
{
	/**
	 * DYChatsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYChat::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYChat
	 */
