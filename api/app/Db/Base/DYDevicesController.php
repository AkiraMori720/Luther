...
use DELIVERY\App\Db\DYDevice as DYDeviceReal;
use DELIVERY\App\Db\DYDevicesResults as DYDevicesResultsReal;
use DELIVERY\App\Db\DYDevicesQuery as DYDevicesQueryReal;

/**
 * Class DYDevicesController
 */
abstract class DYDevicesController extends ORMControllerBase
{
	/**
	 * DYDevicesController constructor.
	 *
	 * @inheritdoc
	 */
	public function __construct()
	{
		parent::__construct(
			...
			DYDevicesResultsReal::class
		);
	}

	/**
	 * Adds item to `dy_devices`.
	 *
	 * @param array $values the row values
	 *
	 * @throws \Throwable
	 *
	 * @return \DELIVERY\App\Db\DYDevice
	 */
	public function addItem(array $values = [])
	{
		/** @var \DELIVERY\App\Db\DYDevice $result */
	...
	/**
	 * Updates one item in `dy_devices`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYDevice` when the item was successfully updated,
	 ...
	 * @throws \Throwable
	 *
	 * @return bool|\DELIVERY\App\Db\DYDevice
	 */
	...
	/**
	 * Updates all items in `dy_devices` that match the given item filters.
	 *
	 * @param array $filters    the row filters
	 * @param array $new_values the new values
	 *
	...
	/**
	 * Deletes one item from `dy_devices`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYDevice` when the item was successfully deleted,
	...
	/**
	 * Deletes all items in `dy_devices` that match the given item filters.
	 *
	 * @param array $filters the row filters
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets item from `dy_devices` that match the given filters.
	 *
	 * The returned value will be:
	 ...
	 * @throws \Throwable
	 *
	 * @return null|\DELIVERY\App\Db\DYDevice
	 */
	public function getItem(array $filters, array $order_by = [])
	{
		/* @var null|\DELIVERY\App\Db\DYDevice $result */
	...
	/**
	 * Gets all items from `dy_devices` that match the given filters.
	 *
	 * @param array    $filters  the row filters
	...
	{
		/** @var \DELIVERY\App\Db\DYDevice[] $results */
	...
	/**
	 * Gets all items from `dy_devices` with a custom query builder instance.
	 *
