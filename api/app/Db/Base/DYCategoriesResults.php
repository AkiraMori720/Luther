...
/**
 * Class DYCategoriesResults
 */
abstract class DYCategoriesResults extends ORMResultsBase
{
	/**
	 * DYCategoriesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYCategory::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYCategory
	 */
