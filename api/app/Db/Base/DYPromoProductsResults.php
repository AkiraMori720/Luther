...
/**
 * Class DYPromoProductsResults
 */
abstract class DYPromoProductsResults extends ORMResultsBase
{
	/**
	 * DYPromoProductsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYPromoProduct::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYPromoProduct
	 */
