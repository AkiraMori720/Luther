...
/**
 * Class DYAddressesResults
 */
abstract class DYAddressesResults extends ORMResultsBase
{
	/**
	 * DYAddressesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYAddress::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYAddress
	 */
