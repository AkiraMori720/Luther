 ...
 * Class DYVatsResults
 */
abstract class DYVatsResults extends ORMResultsBase
{
	/**
	 * DYVatsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYVat::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYVat
	 */
