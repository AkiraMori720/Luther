...
/**
 * Class DYOrdersResults
 */
abstract class DYOrdersResults extends ORMResultsBase
{
	/**
	 * DYOrdersResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYOrder::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYOrder
	 */
