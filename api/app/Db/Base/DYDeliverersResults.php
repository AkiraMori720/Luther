...
/**
 * Class DYDeliverersResults
 */
abstract class DYDeliverersResults extends ORMResultsBase
{
	/**
	 * DYDeliverersResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYDeliverer::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYDeliverer
	 */
