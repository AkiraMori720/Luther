...
use DELIVERY\App\Db\DYPromo as DYPromoReal;
use DELIVERY\App\Db\DYPromosResults as DYPromosResultsReal;
use DELIVERY\App\Db\DYPromosQuery as DYPromosQueryReal;

/**
 * Class DYPromosController
 */
abstract class DYPromosController extends ORMControllerBase
{
	/**
	 * DYPromosController constructor.
	 *
	 * @inheritdoc
	 */
	public function __construct()
	{
		parent::__construct(
			...
			DYPromosResultsReal::class
		);
	}

	/**
	 * Adds item to `dy_promos`.
	 *
	 * @param array $values the row values
	 *
	 * @throws \Throwable
	 *
	 * @return \DELIVERY\App\Db\DYPromo
	 */
	public function addItem(array $values = [])
	{
		/** @var \DELIVERY\App\Db\DYPromo $result */
	...
	/**
	 * Updates one item in `dy_promos`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYPromo` when the item was successfully updated,
	 ...
	 * @throws \Throwable
	 *
	 * @return bool|\DELIVERY\App\Db\DYPromo
	 */
	...
	/**
	 * Updates all items in `dy_promos` that match the given item filters.
	 *
	 * @param array $filters    the row filters
	 * @param array $new_values the new values
	 *
	...
	/**
	 * Deletes one item from `dy_promos`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYPromo` when the item was successfully deleted,
	...
	/**
	 * Deletes all items in `dy_promos` that match the given item filters.
	 *
	 * @param array $filters the row filters
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets item from `dy_promos` that match the given filters.
	 *
	 * The returned value will be:
	 ...
	 * @throws \Throwable
	 *
	 * @return null|\DELIVERY\App\Db\DYPromo
	 */
	public function getItem(array $filters, array $order_by = [])
	{
		/* @var null|\DELIVERY\App\Db\DYPromo $result */
	...
	/**
	 * Gets all items from `dy_promos` that match the given filters.
	 *
	 * @param array    $filters  the row filters
	...
	{
		/** @var \DELIVERY\App\Db\DYPromo[] $results */
	...
	/**
	 * Gets all items from `dy_promos` with a custom query builder instance.
	 *
