...
/**
 * Class DYDeliveriesResults
 */
abstract class DYDeliveriesResults extends ORMResultsBase
{
	/**
	 * DYDeliveriesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYDelivery::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYDelivery
	 */
