...
use DELIVERY\App\Db\DYFee as DYFeeReal;
use DELIVERY\App\Db\DYFeesResults as DYFeesResultsReal;
use DELIVERY\App\Db\DYFeesQuery as DYFeesQueryReal;

/**
 * Class DYFeesController
 */
abstract class DYFeesController extends ORMControllerBase
{
	/**
	 * DYFeesController constructor.
	 *
	 * @inheritdoc
	 */
	public function __construct()
	{
		parent::__construct(
			...
			DYFeesResultsReal::class
		);
	}

	/**
	 * Adds item to `dy_fees`.
	 *
	...
	{
		/** @var \DELIVERY\App\Db\DYFee $result */
	...
	/**
	 * Updates one item in `dy_fees`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYFee` when the item was successfully updated,
	 ...
	 * @throws \Throwable
	 *
	 * @return bool|\DELIVERY\App\Db\DYFee
	 */
	...
	/**
	 * Updates all items in `dy_fees` that match the given item filters.
	 *
	 * @param array $filters    the row filters
	 * @param array $new_values the new values
	 *
	...
	/**
	 * Deletes one item from `dy_fees`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYFee` when the item was successfully deleted,
	...
	/**
	 * Deletes all items in `dy_fees` that match the given item filters.
	 *
	 * @param array $filters the row filters
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets item from `dy_fees` that match the given filters.
	 *
	 * The returned value will be:
	 ...
	 * @throws \Throwable
	 *
	 * @return null|\DELIVERY\App\Db\DYFee
	 */
	public function getItem(array $filters, array $order_by = [])
	{
		/* @var null|\DELIVERY\App\Db\DYFee $result */
	...
	/**
	 * Gets all items from `dy_fees` that match the given filters.
	 *
	 * @param array    $filters  the row filters
	...
	{
		/** @var \DELIVERY\App\Db\DYFee[] $results */
	...
	/**
	 * Gets all items from `dy_fees` with a custom query builder instance.
	 *
