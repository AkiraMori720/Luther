...
/**
 * Class DYOrderDiscountsResults
 */
abstract class DYOrderDiscountsResults extends ORMResultsBase
{
	/**
	 * DYOrderDiscountsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYOrderDiscount::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYOrderDiscount
	 */
