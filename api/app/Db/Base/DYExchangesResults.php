...
/**
 * Class DYExchangesResults
 */
abstract class DYExchangesResults extends ORMResultsBase
{
	/**
	 * DYExchangesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYExchange::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYExchange
	 */
