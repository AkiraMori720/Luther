...
/**
 * Class DYCompaniesResults
 */
abstract class DYCompaniesResults extends ORMResultsBase
{
	/**
	 * DYCompaniesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYCompany::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYCompany
	 */
