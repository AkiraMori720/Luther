...
use DELIVERY\App\Db\DYAddress as DYAddressReal;
use DELIVERY\App\Db\DYAddressesResults as DYAddressesResultsReal;
use DELIVERY\App\Db\DYAddressesQuery as DYAddressesQueryReal;

/**
 * Class DYAddressesController
 */
abstract class DYAddressesController extends ORMControllerBase
{
	/**
	 * DYAddressesController constructor.
	 *
	 * @inheritdoc
	 */
	public function __construct()
	{
		parent::__construct(
			...
			DYAddress::TABLE_NAME,
			DYAddressReal::class,
			DYAddressesQueryReal::class,
			DYAddressesResultsReal::class
		);
	}

	/**
	 * Adds item to `dy_addresses`.
	 *
	 * @param array $values the row values
	 *
	 * @throws \Throwable
	 *
	 * @return \DELIVERY\App\Db\DYAddress
	 */
	public function addItem(array $values = [])
	{
		/** @var \DELIVERY\App\Db\DYAddress $result */
	...
	/**
	 * Updates one item in `dy_addresses`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYAddress` when the item was successfully updated,
	 ...
	 * @throws \Throwable
	 *
	 * @return bool|\DELIVERY\App\Db\DYAddress
	 */
	...
	/**
	 * Updates all items in `dy_addresses` that match the given item filters.
	 *
	 * @param array $filters    the row filters
	 * @param array $new_values the new values
	 *
	...
	/**
	 * Deletes one item from `dy_addresses`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYAddress` when the item was successfully deleted,
	...
	/**
	 * Deletes all items in `dy_addresses` that match the given item filters.
	 *
	 * @param array $filters the row filters
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets item from `dy_addresses` that match the given filters.
	 *
	 * The returned value will be:
	 ...
	 * @throws \Throwable
	 *
	 * @return null|\DELIVERY\App\Db\DYAddress
	 */
	public function getItem(array $filters, array $order_by = [])
	{
		/* @var null|\DELIVERY\App\Db\DYAddress $result */
	...
	/**
	 * Gets all items from `dy_addresses` that match the given filters.
	 *
	 * @param array    $filters  the row filters
	...
	{
		/** @var \DELIVERY\App\Db\DYAddress[] $results */
	...
	/**
	 * Gets all items from `dy_addresses` with a custom query builder instance.
	 *
