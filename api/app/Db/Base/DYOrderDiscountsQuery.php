 ...
 */
abstract class DYOrderDiscountsQuery extends ORMTableQueryBase
{
	/**
	 * DYOrderDiscountsQuery constructor.
	 */
	public function __construct()
	{
		parent::__construct(
			...
			\DELIVERY\App\Db\DYOrderDiscountsResults::class
		);
	}

	/**
	 * Finds rows in the table `dy_discounts` and returns a new instance of the table's result iterator.
	 *
	 * @param null|int $max
	 * @param int      $offset
	 ...
	 *
	 * @return \DELIVERY\App\Db\DYOrderDiscountsResults
	 */
	public function find($max = null, $offset = 0, array $order_by = [])
	{
		/* @var \DELIVERY\App\Db\DYOrderDiscountsResults $results */
	...
	/**
	 * Filters rows with condition on column `id` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	 * @return $this|\DELIVERY\App\Db\DYOrderDiscountsQuery
	 * @throws \Gobl\DBAL\Exceptions\DBALException
	...
	/**
	 * Filters rows with condition on column `user_id` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `order_id` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `order_line_id` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `promo_id` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `amount` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `currency_code` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `exchange_id` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `before_vat` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `data` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `add_time` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `update_time` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
	...
	/**
	 * Filters rows with condition on column `valid` in the table `dy_discounts`.
	 *
	 * @param mixed  $value    the filter value
	 * @param int    $operator the operator to use
	 *
