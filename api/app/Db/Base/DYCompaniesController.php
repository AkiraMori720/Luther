...
use DELIVERY\App\Db\DYCompany as DYCompanyReal;
use DELIVERY\App\Db\DYCompaniesResults as DYCompaniesResultsReal;
use DELIVERY\App\Db\DYCompaniesQuery as DYCompaniesQueryReal;

/**
 * Class DYCompaniesController
 */
abstract class DYCompaniesController extends ORMControllerBase
{
	/**
	 * DYCompaniesController constructor.
	 *
	 * @inheritdoc
	 */
	public function __construct()
	{
		parent::__construct(
			...
			DYCompaniesResultsReal::class
		);
	}

	/**
	 * Adds item to `dy_companies`.
	 *
	 * @param array $values the row values
	 *
	 * @throws \Throwable
	 *
	 * @return \DELIVERY\App\Db\DYCompany
	 */
	public function addItem(array $values = [])
	{
		/** @var \DELIVERY\App\Db\DYCompany $result */
	...
	/**
	 * Updates one item in `dy_companies`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYCompany` when the item was successfully updated,
	 ...
	 * @throws \Throwable
	 *
	 * @return bool|\DELIVERY\App\Db\DYCompany
	 */
	...
	/**
	 * Updates all items in `dy_companies` that match the given item filters.
	 *
	 * @param array $filters    the row filters
	 * @param array $new_values the new values
	 *
	...
	/**
	 * Deletes one item from `dy_companies`.
	 *
	 * The returned value will be:
	 * - `false` when the item was not found
	 * - `DYCompany` when the item was successfully deleted,
	...
	/**
	 * Deletes all items in `dy_companies` that match the given item filters.
	 *
	 * @param array $filters the row filters
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets item from `dy_companies` that match the given filters.
	 *
	 * The returned value will be:
	...
	{
		/* @var null|\DELIVERY\App\Db\DYCompany $result */
	...
	/**
	 * Gets all items from `dy_companies` that match the given filters.
	 *
	 * @param array    $filters  the row filters
	...
	{
		/** @var \DELIVERY\App\Db\DYCompany[] $results */
	...
	/**
	 * Gets all items from `dy_companies` with a custom query builder instance.
	 *
