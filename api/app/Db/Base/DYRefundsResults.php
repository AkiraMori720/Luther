...
/**
 * Class DYRefundsResults
 */
abstract class DYRefundsResults extends ORMResultsBase
{
	/**
	 * DYRefundsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYRefund::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYRefund
	 */
