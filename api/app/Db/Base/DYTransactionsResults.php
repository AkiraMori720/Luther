...
/**
 * Class DYTransactionsResults
 */
abstract class DYTransactionsResults extends ORMResultsBase
{
	/**
	 * DYTransactionsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYTransaction::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYTransaction
	 */
