...
/**
 * Class DYDevicesResults
 */
abstract class DYDevicesResults extends ORMResultsBase
{
	/**
	 * DYDevicesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYDevice::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYDevice
	 */
