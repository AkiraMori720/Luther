 ...
 * Class DYPubsResults
 */
abstract class DYPubsResults extends ORMResultsBase
{
	/**
	 * DYPubsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYPub::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYPub
	 */
