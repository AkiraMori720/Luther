...
/**
 * Class DYProductsResults
 */
abstract class DYProductsResults extends ORMResultsBase
{
	/**
	 * DYProductsResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYProduct::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYProduct
	 */
