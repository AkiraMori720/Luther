 ...
 * Class DYFeesResults
 */
abstract class DYFeesResults extends ORMResultsBase
{
	/**
	 * DYFeesResults constructor.
	 *
	...
	{
		parent::__construct($db, $query, \DELIVERY\App\Db\DYFee::class);
	}

	/**
	 * This is to help editor infer type in loop (foreach or for...)
	 *
	 * @return null|array|\DELIVERY\App\Db\DYFee
	 */
