...
use Gobl\ORM\ORM;
use DELIVERY\App\Db\DYOrderLinesController;
use DELIVERY\App\Db\DYOrderLine;
...
/**
 * Class DYOrderLinesService
 *
 * to add item to order-lines
 * - POST    /order-lines
 *
 * to update property(ies) of the item with the given :order_line_id
 * - PATCH     /order-lines/:order_line_id
 *
 * to update property(ies) of all items in `dy_order_lines`
 * - PATCH     /order-lines
 *
 * to delete item with the given :order_line_id
 * - DELETE  /order-lines/:order_line_id
 *
 * to delete all items in `dy_order_lines`
 * - DELETE  /order-lines
 *
 * to get the item with the given :order_line_id
 * - GET     /order-lines/:order_line_id
 *
 * to get all items in dy_order_lines
 * - GET     /order-lines
 *
 * to get relation for the item in `dy_order_lines` with the given :order_line_id
 * - GET     /order-lines/:order_line_id/relation
 */
final class DYOrderLinesService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `dy_order_lines`
	 *
	...
	public function actionCreateEntity(ORMRequest $orm_request)
	{
		...
		$controller = new DYOrderLinesController();
	...
	/**
	 * Updates only one item in the table `dy_order_lines` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionUpdateOneItem(ORMRequest $orm_request)
	{
		...
		if ($entity instanceof DYOrderLine) {
			$this->getResponseHolder()
				 ->setDone($controller->getCRUD()
									  ->getMessage())
				 ->setData(['item' => $entity]);
	...
	/**
	 * Updates all items in the table `dy_order_lines` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `dy_order_lines` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `dy_order_lines` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `dy_order_lines` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `dy_order_lines` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionGetAll(ORMRequest $orm_request)
	{
		...
		if ($collection) {
			$table      = ORM::getDatabase('DELIVERY\App\Db')
							 ->getTable(DYOrderLine::TABLE_NAME);
	...
	{
		if (!$orm_request->getColumnFilters(DYOrderLine::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \DELIVERY\App\Db\DYOrderLine        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(DYOrderLine $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \DELIVERY\App\Db\DYOrderLine[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, DYOrderLine $entity)
	{
		$filters          = [];
	...
	public static function registerRoutes(Router $router)
	{
		...
		$options = [
			'order_line_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/order-lines', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/order-lines/{order_line_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('order_line_id', $r->getArg('order_line_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/order-lines', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/order-lines/{order_line_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('order_line_id', $r->getArg('order_line_id'));
			   ...
			   ->patch('/order-lines/{order_line_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('order_line_id', $r->getArg('order_line_id'));
			   ...
			   ->patch('/order-lines', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/order-lines/{order_line_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('order_line_id', $r->getArg('order_line_id'));
			   ...
			   ->delete('/order-lines', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('order_line_id', $r->getArg('order_line_id'));
