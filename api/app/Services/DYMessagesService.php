...
use Gobl\ORM\ORM;
use DELIVERY\App\Db\DYMessagesController;
use DELIVERY\App\Db\DYMessage;
...
/**
 * Class DYMessagesService
 *
 * to add item to messages
 * - POST    /messages
 *
 * to update property(ies) of the item with the given :message_id
 * - PATCH     /messages/:message_id
 *
 * to update property(ies) of all items in `dy_messages`
 * - PATCH     /messages
 *
 * to delete item with the given :message_id
 * - DELETE  /messages/:message_id
 *
 * to delete all items in `dy_messages`
 * - DELETE  /messages
 *
 * to get the item with the given :message_id
 * - GET     /messages/:message_id
 *
 * to get all items in dy_messages
 * - GET     /messages
 *
 * to get relation for the item in `dy_messages` with the given :message_id
 * - GET     /messages/:message_id/relation
 */
final class DYMessagesService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `dy_messages`
	 *
	...
	public function actionCreateEntity(ORMRequest $orm_request)
	{
		...
		$controller = new DYMessagesController();
	...
	/**
	 * Updates only one item in the table `dy_messages` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionUpdateOneItem(ORMRequest $orm_request)
	{
		...
		if ($entity instanceof DYMessage) {
			$this->getResponseHolder()
				 ->setDone($controller->getCRUD()
									  ->getMessage())
				 ->setData(['item' => $entity]);
	...
	/**
	 * Updates all items in the table `dy_messages` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `dy_messages` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `dy_messages` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `dy_messages` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `dy_messages` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	{
		if (!$orm_request->getColumnFilters(DYMessage::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \DELIVERY\App\Db\DYMessage        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(DYMessage $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \DELIVERY\App\Db\DYMessage[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, DYMessage $entity)
	{
		$filters          = [];
	...
	public static function registerRoutes(Router $router)
	{
		...
		$options = [
			'message_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/messages', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/messages/{message_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('message_id', $r->getArg('message_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/messages', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/messages/{message_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('message_id', $r->getArg('message_id'));
			   ...
			   ->patch('/messages/{message_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('message_id', $r->getArg('message_id'));
			   ...
			   ->patch('/messages', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/messages/{message_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('message_id', $r->getArg('message_id'));
			   ...
			   ->delete('/messages', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('message_id', $r->getArg('message_id'));
