...
/**
 * Class OZUsersService
 *
 * to add item to users
 * - POST    /users
 *
 * to update property(ies) of the item with the given :user_id
 * - PATCH     /users/:user_id
 *
 * to update property(ies) of all items in `oz_users`
 * - PATCH     /users
 *
 * to delete item with the given :user_id
 * - DELETE  /users/:user_id
 *
 * to delete all items in `oz_users`
 * - DELETE  /users
 *
 * to get the item with the given :user_id
 * - GET     /users/:user_id
 *
 * to get all items in oz_users
 * - GET     /users
 *
 * to get relation for the item in `oz_users` with the given :user_id
 * - GET     /users/:user_id/relation
 */
final class OZUsersService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `oz_users`
	 *
	...
	/**
	 * Updates only one item in the table `oz_users` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Updates all items in the table `oz_users` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `oz_users` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `oz_users` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `oz_users` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `oz_users` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionGetAll(ORMRequest $orm_request)
	{
		...
		if ($collection) {
			$table      = ORM::getDatabase('OZONE\OZ\Db')
	...
	{
		if (!$orm_request->getColumnFilters(OZUser::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \OZONE\OZ\Db\OZUser        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(OZUser $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \OZONE\OZ\Db\OZUser[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, OZUser $entity)
	{
		$filters          = [];
	...
	{
		return ORM::getDatabase('OZONE\OZ\Db')
				  ->getTable(OZUser::TABLE_NAME);
	}
	...
	public static function registerRoutes(Router $router)
	{
		...
		$options = [
			'user_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/users', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/users/{user_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('user_id', $r->getArg('user_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/users', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/users/{user_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('user_id', $r->getArg('user_id'));
			   ...
			   ->patch('/users/{user_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('user_id', $r->getArg('user_id'));
			   ...
			   ->patch('/users', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/users/{user_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('user_id', $r->getArg('user_id'));
			   ...
			   ->delete('/users', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('user_id', $r->getArg('user_id'));
