...
use Gobl\ORM\ORM;
use DELIVERY\App\Db\DYAddressesController;
use DELIVERY\App\Db\DYAddress;
...
/**
 * Class DYAddressesService
 *
 * to add item to addresses
 * - POST    /addresses
 *
 * to update property(ies) of the item with the given :address_id
 * - PATCH     /addresses/:address_id
 *
 * to update property(ies) of all items in `dy_addresses`
 * - PATCH     /addresses
 *
 * to delete item with the given :address_id
 * - DELETE  /addresses/:address_id
 *
 * to delete all items in `dy_addresses`
 * - DELETE  /addresses
 *
 * to get the item with the given :address_id
 * - GET     /addresses/:address_id
 *
 * to get all items in dy_addresses
 * - GET     /addresses
 *
 * to get relation for the item in `dy_addresses` with the given :address_id
 * - GET     /addresses/:address_id/relation
 */
final class DYAddressesService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `dy_addresses`
	 *
	...
	public function actionCreateEntity(ORMRequest $orm_request)
	{
		...
		$controller = new DYAddressesController();
	...
	/**
	 * Updates only one item in the table `dy_addresses` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionUpdateOneItem(ORMRequest $orm_request)
	{
		...
		if ($entity instanceof DYAddress) {
			$this->getResponseHolder()
				 ->setDone($controller->getCRUD()
									  ->getMessage())
				 ->setData(['item' => $entity]);
	...
	/**
	 * Updates all items in the table `dy_addresses` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `dy_addresses` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `dy_addresses` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `dy_addresses` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `dy_addresses` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	{
		if (!$orm_request->getColumnFilters(DYAddress::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \DELIVERY\App\Db\DYAddress        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(DYAddress $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \DELIVERY\App\Db\DYAddress[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, DYAddress $entity)
	{
		$filters          = [];
	...
	public static function registerRoutes(Router $router)
	{
		...
		$options = [
			'address_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/addresses', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/addresses/{address_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('address_id', $r->getArg('address_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/addresses', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/addresses/{address_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('address_id', $r->getArg('address_id'));
			   ...
			   ->patch('/addresses/{address_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('address_id', $r->getArg('address_id'));
			   ...
			   ->patch('/addresses', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/addresses/{address_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('address_id', $r->getArg('address_id'));
			   ...
			   ->delete('/addresses', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('address_id', $r->getArg('address_id'));
