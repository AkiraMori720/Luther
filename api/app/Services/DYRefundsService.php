...
use Gobl\ORM\ORM;
use DELIVERY\App\Db\DYRefundsController;
use DELIVERY\App\Db\DYRefund;
...
/**
 * Class DYRefundsService
 *
 * to add item to refunds
 * - POST    /refunds
 *
 * to update property(ies) of the item with the given :refund_id
 * - PATCH     /refunds/:refund_id
 *
 * to update property(ies) of all items in `dy_refunds`
 * - PATCH     /refunds
 *
 * to delete item with the given :refund_id
 * - DELETE  /refunds/:refund_id
 *
 * to delete all items in `dy_refunds`
 * - DELETE  /refunds
 *
 * to get the item with the given :refund_id
 * - GET     /refunds/:refund_id
 *
 * to get all items in dy_refunds
 * - GET     /refunds
 *
 * to get relation for the item in `dy_refunds` with the given :refund_id
 * - GET     /refunds/:refund_id/relation
 */
final class DYRefundsService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `dy_refunds`
	 *
	...
	public function actionCreateEntity(ORMRequest $orm_request)
	{
		...
		$controller = new DYRefundsController();
	...
	/**
	 * Updates only one item in the table `dy_refunds` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Updates all items in the table `dy_refunds` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `dy_refunds` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `dy_refunds` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `dy_refunds` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `dy_refunds` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	{
		if (!$orm_request->getColumnFilters(DYRefund::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \DELIVERY\App\Db\DYRefund        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(DYRefund $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \DELIVERY\App\Db\DYRefund[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, DYRefund $entity)
	{
		$filters          = [];
	...
	public static function registerRoutes(Router $router)
	{
		...
		$options = [
			'refund_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/refunds', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/refunds/{refund_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('refund_id', $r->getArg('refund_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/refunds', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/refunds/{refund_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('refund_id', $r->getArg('refund_id'));
			   ...
			   ->patch('/refunds/{refund_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('refund_id', $r->getArg('refund_id'));
			   ...
			   ->patch('/refunds', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/refunds/{refund_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('refund_id', $r->getArg('refund_id'));
			   ...
			   ->delete('/refunds', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('refund_id', $r->getArg('refund_id'));
