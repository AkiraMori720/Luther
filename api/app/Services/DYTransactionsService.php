...
use Gobl\ORM\ORM;
use DELIVERY\App\Db\DYTransactionsController;
use DELIVERY\App\Db\DYTransaction;
...
/**
 * Class DYTransactionsService
 *
 * to add item to transactions
 * - POST    /transactions
 *
 * to update property(ies) of the item with the given :transaction_id
 * - PATCH     /transactions/:transaction_id
 *
 * to update property(ies) of all items in `dy_transactions`
 * - PATCH     /transactions
 *
 * to delete item with the given :transaction_id
 * - DELETE  /transactions/:transaction_id
 *
 * to delete all items in `dy_transactions`
 * - DELETE  /transactions
 *
 * to get the item with the given :transaction_id
 * - GET     /transactions/:transaction_id
 *
 * to get all items in dy_transactions
 * - GET     /transactions
 *
 * to get relation for the item in `dy_transactions` with the given :transaction_id
 * - GET     /transactions/:transaction_id/relation
 */
final class DYTransactionsService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `dy_transactions`
	 *
	...
	public function actionCreateEntity(ORMRequest $orm_request)
	{
		...
		$controller = new DYTransactionsController();
	...
	/**
	 * Updates only one item in the table `dy_transactions` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionUpdateOneItem(ORMRequest $orm_request)
	{
		...
		if ($entity instanceof DYTransaction) {
			$this->getResponseHolder()
				 ->setDone($controller->getCRUD()
									  ->getMessage())
				 ->setData(['item' => $entity]);
	...
	/**
	 * Updates all items in the table `dy_transactions` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `dy_transactions` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `dy_transactions` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `dy_transactions` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `dy_transactions` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionGetAll(ORMRequest $orm_request)
	{
		...
		if ($collection) {
			$table      = ORM::getDatabase('DELIVERY\App\Db')
							 ->getTable(DYTransaction::TABLE_NAME);
	...
	{
		if (!$orm_request->getColumnFilters(DYTransaction::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \DELIVERY\App\Db\DYTransaction        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(DYTransaction $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \DELIVERY\App\Db\DYTransaction[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, DYTransaction $entity)
	{
		$filters          = [];
	...
	{
		$type_obj    = self::table()
						   ->getColumn(DYTransaction::COL_ID)
						   ->getTypeObject();
		...
		$options = [
			'transaction_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/transactions', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/transactions/{transaction_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('transaction_id', $r->getArg('transaction_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/transactions', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/transactions/{transaction_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('transaction_id', $r->getArg('transaction_id'));
			   ...
			   ->patch('/transactions/{transaction_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('transaction_id', $r->getArg('transaction_id'));
			   ...
			   ->patch('/transactions', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/transactions/{transaction_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('transaction_id', $r->getArg('transaction_id'));
			   ...
			   ->delete('/transactions', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('transaction_id', $r->getArg('transaction_id'));
