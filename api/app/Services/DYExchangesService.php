...
use Gobl\ORM\ORM;
use DELIVERY\App\Db\DYExchangesController;
use DELIVERY\App\Db\DYExchange;
...
/**
 * Class DYExchangesService
 *
 * to add item to exchanges
 * - POST    /exchanges
 *
 * to update property(ies) of the item with the given :exchange_id
 * - PATCH     /exchanges/:exchange_id
 *
 * to update property(ies) of all items in `dy_exchanges`
 * - PATCH     /exchanges
 *
 * to delete item with the given :exchange_id
 * - DELETE  /exchanges/:exchange_id
 *
 * to delete all items in `dy_exchanges`
 * - DELETE  /exchanges
 *
 * to get the item with the given :exchange_id
 * - GET     /exchanges/:exchange_id
 *
 * to get all items in dy_exchanges
 * - GET     /exchanges
 *
 * to get relation for the item in `dy_exchanges` with the given :exchange_id
 * - GET     /exchanges/:exchange_id/relation
 */
final class DYExchangesService extends BaseService
{
	//========================================================
	...
	/**
	 * Creates a new entry in the table `dy_exchanges`
	 *
	...
	public function actionCreateEntity(ORMRequest $orm_request)
	{
		...
		$controller = new DYExchangesController();
	...
	/**
	 * Updates only one item in the table `dy_exchanges` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionUpdateOneItem(ORMRequest $orm_request)
	{
		...
		if ($entity instanceof DYExchange) {
			$this->getResponseHolder()
				 ->setDone($controller->getCRUD()
									  ->getMessage())
				 ->setData(['item' => $entity]);
	...
	/**
	 * Updates all items in the table `dy_exchanges` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes only one item in the table `dy_exchanges` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Deletes all items in the table `dy_exchanges` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets only one item from the table `dy_exchanges` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	/**
	 * Gets all items from the table `dy_exchanges` that matches some filters
	 *
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 *
	 * @throws \Throwable
	...
	public function actionGetAll(ORMRequest $orm_request)
	{
		...
		if ($collection) {
			$table      = ORM::getDatabase('DELIVERY\App\Db')
							 ->getTable(DYExchange::TABLE_NAME);
	...
	{
		if (!$orm_request->getColumnFilters(DYExchange::COL_ID)) {
			throw new NotFoundException();
		}
	...
	/**
	 * @param \DELIVERY\App\Db\DYExchange        $entity
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 ...
	 * @return array
	 */
	private function listEntityRelations(DYExchange $entity, ORMRequest $orm_request, &$total_records = null)
	{
	...
	/**
	 * @param \DELIVERY\App\Db\DYExchange[]      $entities
	 * @param \OZONE\OZ\Core\ORMRequest $orm_request
	 * @param int                       &$total_records
	 *
	 * @throws \OZONE\OZ\Exceptions\NotFoundException
	 ...
	 * @return mixed
	 */
	private function getRelationItem(Relation $relation, DYExchange $entity)
	{
		$filters          = [];
	...
	public static function registerRoutes(Router $router)
	{
		...
		$options = [
			'exchange_id'    => $is_number ? '[0-9]+' : '[^/]+',
			'relation' => Relation::NAME_PATTERN,
		];

		$router->post('/exchanges', function (RouteInfo $r) {
			...
			return $service->respond();
			   ...
			   ->get('/exchanges/{exchange_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('exchange_id', $r->getArg('exchange_id'));
			   	$service = new self($context);
			   	$service->actionGetEntity($orm_request);

			   	return $service->respond();
			   }, $options)
			   ->get('/exchanges', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->get('/exchanges/{exchange_id}/{relation}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('exchange_id', $r->getArg('exchange_id'));
			   ...
			   ->patch('/exchanges/{exchange_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('exchange_id', $r->getArg('exchange_id'));
			   ...
			   ->patch('/exchanges', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$service     = new self($context);
			   ...
			   ->delete('/exchanges/{exchange_id}', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('exchange_id', $r->getArg('exchange_id'));
			   ...
			   ->delete('/exchanges', function (RouteInfo $r) {
			   	$context     = $r->getContext();
			   	$orm_request = new ORMRequest($context, $context->getRequest()
																   ->getFormData());
			   	$orm_request->addColumnFilter('exchange_id', $r->getArg('exchange_id'));
